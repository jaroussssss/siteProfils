...
export function renderClickChartSpecific(canvas, labels, values) {
  if (window._clickChartSpecific) { window._clickChartSpecific.destroy(); }
  const pieColors = ['#2e86de','#e74c3c','#27ae60','#8e44ad','#f1c40f','#16a085','#d35400','#c0392b','#9b59b6','#1abc9c','#7f8c8d','#2980b9','#e67e22','#bdc3c7'];
  window._clickChartSpecific = new Chart(canvas.getContext('2d'), {
    type: 'doughnut',
    data: {
      labels,
      datasets: [{
